...
import ma.sobexime.muturama.config.audit.AuditEventConverter;
import ma.sobexime.muturama.domain.PersistentAuditEvent;
...
import static ma.sobexime.muturama.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
